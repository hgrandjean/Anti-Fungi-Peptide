...
Employs Support Vector Classifier (SVC) to discriminate between high and low activity AMPs using available data (from Fjell, C. D. et al. Identification of Novel Antibacterial Peptides by Chemoinformatics and Machine Learning. J. Med. Chem. 52, 2006–2015 (2009)). The model takes into account hydrophobibity, descriptors scores and in-vivo aggregation score (a3v_Sequence_Average) generated by Aggrescan online tool. Hydrophobic moment is computed from the Eisenberg formula. This value was computed from the function develloped in the github repository: https://github.com/JoaoRodrigues/hydrophobic_moment/blob/main/hydrophobic_moment.py; 

> **SVC** Support vector Machine method used to create a distinction method within training dataset with more than 2 variates. Was estimated the false positive and false negative classification confidence and ploted as bivariate density plot over 1000 bootstraps of the SVC repetition. 
> 
> Thus, the goal of SVC is to eliminate peptides which have a high propensity of having low biological activity. 
